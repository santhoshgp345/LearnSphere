...
function CourseDetailsCard({ course, setConfirmationModal, handleBuyCourse }) {
  ...
  return (
    <>
      <div
        className={`flex flex-col gap-4 rounded-xl bg-gray-800 p-4`}
      >
        {/* Course Image */}
        <img
          src={ThumbnailImage}
        ...
        <div className="px-4">
          ...
          <div className="flex flex-col gap-4">
            <button
              className="yellowButton bg-yellow-500 p-3 rounded-md font-bold"
              onClick={
          ...
          <div className="text-center">
            <button
              className="mx-auto flex items-center gap-2 py-6 text-white text-lg"
              onClick={handleShare}
            >
